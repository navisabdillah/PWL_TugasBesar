...
<div class="wrapper">
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ route('barangs.index') }}">
          <img src="{{asset('images/Mie Sedap Goreng.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="#">
          <img src="{{asset('images/Mie Sedap Soto.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
          <a href="{{ route('transaksis.index') }}" class="text-decoration-none">
            <p class="card-text">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ route('transaksis.index') }}">
          <img src="{{asset('images/Kari Ayam.jpg') }}" alt="foto produk" class="card-img-top">
        </a>
        <div class="card-body">
